...
class OrderStatusSent extends StatefulWidget {
  const OrderStatusSent({Key key}) : super(key: key);

  @override
  _OrderStatusSentState createState() => _OrderStatusSentState();
}

class _OrderStatusSentState extends State<OrderStatusSent> {
