class OrderSentPerson {
  bool ok;
  List<Sentperson> sentperson;

  OrderSentPerson({this.ok, this.sentperson});

  OrderSentPerson.fromJson(Map<String, dynamic> json) {
    ok = json['ok'];
    if (json['sentperson'] != null) {
      sentperson = new List<Sentperson>();
      json['sentperson'].forEach((v) {
        sentperson.add(new Sentperson.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['ok'] = this.ok;
    if (this.sentperson != null) {
      data['sentperson'] = this.sentperson.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class Sentperson {
  ...
  Sentperson.fromJson(Map<String, dynamic> json) {
    sentId = json['sent_id'];
